...
with open("C:/Users/Shashank Shetty/Downloads/AIML TERMWORKS/PART-B/tm1/enjoySport.csv",'r') as csvfile:
    next(csvfile)
...
for i in range(len(a)):
    ...
    print("Hypothesis for the training instance ",i+1," is : ",hypothesis,"\n")
