...
print("Prodication using NaiveBayes for word asdfgh ",predict_naive_bayes('asdfgh'))
print("Prodication using NaiveBayes for word 'Hi Mom,How are you'",predict_naive_bayes("Hi Mom,How are you?"))
